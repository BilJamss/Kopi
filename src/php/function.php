...
$koneksi = mysqli_connect("localhost", "root", "", "cofeeshop");
...

{
    ...
    $cek_username = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT * FROM `karyawan` WHERE username = '$username'"));
...

{
    ...
    $cek= mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT * FROM `karyawan` 
...

{
    ...
    mysqli_query($koneksi, "DELETE FROM pembayaran
